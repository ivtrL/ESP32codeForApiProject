...
AuthResponse AuthClient::loginJwtToken(AuthLoginResquest authLoginRequest, char* httpLoginServer) {
...
AuthResponse AuthClient::refreshJwtToken(String refreshToken, char* httpRefreshTokenServer) {
    char jsonOutput[768];
    AuthResponse authResponse;
    authResponse.error = false;
